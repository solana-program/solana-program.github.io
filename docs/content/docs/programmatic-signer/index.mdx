...
- A relayer submits it later and pays the fee
...
- Make payments from a treasury whose approval key never goes online. An operator submits them and pays the network transaction fees.
