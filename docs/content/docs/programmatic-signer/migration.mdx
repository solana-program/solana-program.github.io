...
2. [Create an SPL Nonce account](/docs/programmatic-signer/usage#create-a-nonce-account) with the PDA as its authority.
3. Create a System durable nonce account for each migration transaction with `solana create-nonce-account`. Its authority signs the migration transaction.
