...
In the execution message, the field holds the current nonce value. Executor compares it to the stored value and does not care whether it looks like a recent blockhash.
